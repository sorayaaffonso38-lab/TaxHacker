...
const envSchema = z.object({
  ...
  RESEND_FROM_EMAIL: z.string().default("MeiControl <user@localhost>"),
...
const config = {
  app: {
    title: "MeiControl",
    description: "Contabilidade inteligente para MEI e pequenas empresas",
    version: process.env.npm_package_version || "0.0.1",
    baseURL: env.BASE_URL || `http://localhost:${env.PORT || "7331"}`,
    supportEmail: "suporte@meicontrol.com.br",
  },
  upload: {
